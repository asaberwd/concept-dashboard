...
const Lead = React.lazy(() => import('./views/Notifications/Lead'));
...
const routes = [
  ...
  { path: '/buttons', exact: true, name: 'Buttons', component: Products },
  { path: '/buttons/buttons', name: 'Buttons', component: Products },
  { path: '/buttons/button-dropdowns', name: 'Button Dropdowns', component: AddProduct },
  ...
  { path: '/notifications', exact: true, name: 'Notifications', component: Lead },
  { path: '/notifications/lead', name: 'Lead', component: Lead },
