...
class MakeOrder extends React.Component {
    ...
    state ={
        orderProducts : [{product_id: "0", name: '', price: 0, quantity: 1, total : 0}],
        total : 0,
    }
    ...
    render(){
        const { states, cities, products, orderProducts, total } = this.state
        ...
        return(
            ...
            <Card>
              ...
              <CardBody>
                ...
                <FormGroup>
                  <Label htmlFor="street"> Shipping company </Label>
                  <Input type="textarea" id="street" placeholder="Enter street name" />
                </FormGroup>
              ...
              <CardFooter>
                <Button className="btn btn-primary btn-lg btn-block" onClick={this.addProduct} ><i className="fa fa-dot-circle-o"></i> Create Order </Button>
            </CardFooter>
            </Card>
          </Form>
          </Col>
